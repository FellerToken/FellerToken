...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf87f0D8aE978C7D5300b4f8e7b0B2Fc6174D4363;
...
contract FELR is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x23a50Cd564Be24975BbA478288677Eb7A3a2022D;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Feller Token";
    string private _symbol = "FELR";
